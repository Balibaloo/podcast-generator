...
//         ffmpeg -loop 1  -i photo.jpg -i 1.mp3 -i 2.mp3 -i 3.mp3 \
// -filter_complex 'concat=n=3:v=0:a=1' -tune stillimage -shortest out.mp4
    ...
    exec(`ffmpeg -loop 1 -framerate 1 -i MA.jpg -i "${audioFileName}" -c:a copy -c:v libx264 -shortest ${outputFilename}`,(error,stdout,stderr) => {
        if (error){
            console.log(error)
